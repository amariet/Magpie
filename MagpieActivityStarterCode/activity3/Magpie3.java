...
public class Magpie3
{
    ...
    public String getResponse(String statement)
    {
        ...
        || findKeyword(statement, "biological sister") >= 0
        || findKeyword(statement, "biological brother") >= 0
        || findKeyword(statement, "biological sibling") >= 0
        || findKeyword(statement, "sibling") >= 0
        || findKeyword(statement, "roach") >= 0
        || findKeyword(statement, "parasite") >= 0
        || findKeyword(statement, "the parasite that made me a middle child") >= 0
        || findKeyword(statement, "twin") >= 0)
        {
